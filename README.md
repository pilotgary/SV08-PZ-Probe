...
The new 3d printed parts can be found in the STEP directory.  As most modern slicers can open STEP files directly this is the preferred format for this project.  Premade 3MF files for the Bambu Labs A1 mini and STL files are available in the relevant folders.
...
3. Remove the standard nozzle and heatsink assembly. Clicking on the image below will take you to the relevant Sovol video:
...
Combine the part cooling fan interface and nozzle items together with three M3x8 countersunk screws
